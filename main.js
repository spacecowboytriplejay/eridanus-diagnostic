        ...
        <div>
          ...
          <div class="fade-in" style="transition-delay:160ms;">
            <p style="font-size:17px;max-width:460px;margin-bottom:2.5rem;line-height:1.8;">
              Most South African investors with R1 million or more are unknowingly leaving capital on the table. The diagnostic below shows you roughly where. A free projection shows you exactly, against the position you actually hold.
            </p>
          </div>
          <div class="fade-in" style="transition-delay:240ms;display:flex;gap:1rem;flex-wrap:wrap;">
            ...
            <a href="${APPLY_URL}" style="display:inline-flex;align-items:center;gap:6px;font-size:14px;color:var(--text-2);text-decoration:none;border-bottom:1px solid var(--border);padding-bottom:2px;align-self:center;transition:color 200ms,border-color 200ms;" onmouseover="this.style.color='var(--gold)';this.style.borderColor='var(--gold-border)'" onmouseout="this.style.color='var(--text-2)';this.style.borderColor='var(--border)'">Or skip straight to your free projection &darr;</a>
          </div>
          ${REASSURE('left')}
